...
import { Employee, Manager } from "@/app/types";
...
const EditEmployeeForm = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      manager: employee.employeeManager || "",
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {role === "admin" && (
          <Box display="flex" alignItems="center" justifyContent="space-between" my={2}>
            ...
            <Select
              {...register("manager")}
              defaultValue={employee.employeeManager || ""}
              label="Manager"
              sx={{ width: "222px" }}
            >
        ...
        {role === "admin" && (
          <Box display="flex" alignItems="center" justifyContent="space-between" mt={1} my={2}>
        ...
        <Box display="flex" alignItems="center" justifyContent="flex-end" gap={2} mt={2} my={2}>
